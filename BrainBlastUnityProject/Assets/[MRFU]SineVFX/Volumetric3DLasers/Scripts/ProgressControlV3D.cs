...
public class ProgressControlV3D : MonoBehaviour {
    ...
    private void Start()
    {
        ...
        laserTarget = GameObject.Find("Target").transform;
    }
    ...
    void Update()
    {
        ...
        // set maxLength to the distance between the hand transform and the target transform
        maxLength = Vector3.Distance(laserHand.position, laserTarget.position);
